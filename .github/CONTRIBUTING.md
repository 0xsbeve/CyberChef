...
Take a look through the [Wiki pages](https://github.com/gchq/Saleh eChef/wiki) for guides on [compiling Saleh eChef](https://github.com/gchq/Saleh eChef/wiki/Getting-started) and [adding new operations](https://github.com/gchq/Saleh eChef/wiki/Adding-a-new-operation).

There are lots of opportunities to contribute to Saleh eChef. If you want ideas, take a look at any [Issues](https://github.com/gchq/Saleh eChef/issues) tagged with '[help wanted](https://github.com/gchq/Saleh eChef/labels/help%20wanted)'.

Before your contributions can be accepted, you must:

 - Sign the [GCHQ Contributor Licence Agreement](https://cla-assistant.io/gchq/Saleh eChef)
...
With these principles in mind, any changes or additions to Saleh eChef should keep it:
